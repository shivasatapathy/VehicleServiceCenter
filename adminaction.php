...
$query1=mysqli_query($con,"SELECT * FROM customer_data WHERE booking_id='$booking_id'");
...
if(!$mail->send())
{
	...
	if(!isset($_SESSION['email'])){
		...
		alert("You Application is submitted successfully");
		window.location.href='index';
		</script><?php
	}
	else{
		if ($status=='cancel') {
			$query1=mysqli_query($con,"DELETE FROM customer_data WHERE booking_id='$booking_id'");
		}
		?><script type="text/javascript">
